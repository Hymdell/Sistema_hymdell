...
const modals = {
  ...
  modalSourceCode: document.getElementById('modalSourceCode'),
};
...
document.getElementById('btnSourceCode').addEventListener('click', () => {
  openModal('modalSourceCode');
  loadSourceCode();
});
...
document.getElementById('btnMobileAddService').addEventListener('click', () => {
  openModal('modalAddService');
  closeMobileMenu();
});
document.getElementById('btnMobileViewCharts').addEventListener('click', () => {
